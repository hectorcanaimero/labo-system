...
title: "F5 — Post-Migration Cleanup & Hardening"
---

# F5 — Post-Migration Cleanup & Hardening

## F5.1 — Package: hardening

### F5.1.T1 — Fix regex de cédula venezolana (soporte 9 dígitos)
...
- **Estimación**: 0.5h
- **Razón**: Fix quirúrgico de regex y suite unitaria en packages/lib con DeepSeek V4 Pro.
- **Dependencies**:
- **Files**:
  - `packages/lib/cedula.ts`
  - `packages/lib/cedula.test.ts`

### F5.1.T2 — Purga total de residuos Convex en configs y workspace
...
- **Estimación**: 1.5h
- **Razón**: Limpieza exhaustiva de dependencias, configuraciones de build y archivos legados con GPT-5.6 Codex.
- **Dependencies**:
- **Files**:
...
### F5.1.T3 — Arreglo de Typecheck en monorepo
...
- **Estimación**: 1.5h
- **Razón**: Razonamiento de tipos e interfaces complejas en monorepo con Gemini 3.1 Pro.
- **Dependencies**: F5.1.T1, F5.1.T2
- **Files**:
...
### F5.1.T4 — Conectar sesión real (/api/me) y logout en Header y AppLayout
...
- **Modelo**: opencode/deepseek-v4-pro
- **Estimación**: 2h
- **Razón**: Integración de sesión frontend, ciclo de vida de autenticación y logout con DeepSeek V4 Pro.
