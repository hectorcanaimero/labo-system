...
export async function GET(
  ...
  try {
    ...
    const examen = await examenesGetById({ id: context.params.id });
    if (!examen) {
...
export async function PATCH(
  ...
  try {
    ...
    const examen = await examenesUpdate({
...
export async function DELETE(
  ...
  try {
    ...
    const examen = await examenesDeactivate({
      id: context.params.id,
      usuarioId: user.userId,
    });
    return NextResponse.json(examen);
...
export async function POST(
  ...
  try {
    ...
    const examen = await examenesActivate({
      id: context.params.id,
      usuarioId: user.userId,
    });
    return NextResponse.json(examen);
